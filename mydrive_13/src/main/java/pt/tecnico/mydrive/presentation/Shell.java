...
public abstract class Shell {
  ...
  public Shell(String n, Writer w, boolean flush) {
	...
	LoginService ls = new LoginService("nobody", null);
	ls.execute();
	currentToken = ls.result();
	this.addToken("nobody",currentToken);  
    name = n;
  ...
  public long getCurrentToken() { return currentToken; }
  public void updateSession(long token) { currentToken = token; }
  public void addToken(String username, long token) {tokens.put(username, token); }
  public Long getTokenByUsername(String username) { return tokens.get(username);}
